...
// A statement that consists of solely of one expression.
type ExpressionStatement struct {
	Token      tk.Token // The fitst token of the expression
...
type InfixExpression struct {
	Token    tk.Token // operator token, e.g. +
	Left     Expression
	Operator string
	Right    Expression
}
